...
public class viaje {
    ...
    public viaje(LocalDateTime fechaSalida, String duracion, String destino, TipoAlojamiento tipoAlojamiento, PreferenciaTransporte preferenciaTransporte, String dieta){
